...
@include('layouts.header', ['title' => 'Мои заявки', 'headerTitle' => 'Мои заявки'])
    <main class="mt-2 animate-fade-in-up">
        <div class="flex p-5">
        ...
        <div class="p-5">
            @foreach ($requests as $request)
                <div class="flex items-center gap-5 bg-white/95 backdrop-blur-xl p-3 sm:p-5 my-2 mx-auto rounded-xl shadow-xl max-w-370">
                    <div class="">
