...
<body class="min-h-screen bg-[url('/public/images/wave.svg')] bg-no-repeat bg-bottom">
    <header class="flex justify-between bg-white/80 backdrop-blur-xl mt-4 sm:mt-2 p-3 sm:p-5 mx-auto rounded-xl shadow-xl max-w-370">
        <div class="flex gap-3 items-center">
            ...
            <h1 class="font-semibold text-xl font-serif">Реестр заявок - Управление - База знаний</h1>
        </div>
    ...
    <main>
        <div class="flex p-5">
            <a href="{{ route('new_article') }}" class="flex justify-center items-center rounded-md bg-blue-400 py-1 px-3 text-white font-semibold shadow-lg hover:shadow-xl focus:shadow-xl
            hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-150 ease-in-out cursor-pointer">+</a>
        </div>
        <div class="">
